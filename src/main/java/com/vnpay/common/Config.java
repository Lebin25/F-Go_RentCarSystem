...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/success.jsp";
    public static String vnp_TmnCode = "FGQOB9KX";
    public static String vnp_HashSecret = "YWOIELEOSACKXZSZCRZHHHLEISZYDLEA";
