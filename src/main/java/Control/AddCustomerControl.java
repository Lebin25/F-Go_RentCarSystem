...
public class AddCustomerControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(cname + cphone + cnationalId + cdrivingLicense + caccountID + cisVerify + cemail);

        CustomerDAO cdao = new CustomerDAO();
        cdao.addCustomer(cname, cphone, cnationalId, cdrivingLicense, caccountID, cisVerify, cemail);
